...
To use Tulu, store owners can either integrate their existing Shopify store or create one manually. When integrated with Shopify, Tulu will automatically fetch all of the store's available products, along with their information, and build an agent that can give customers product recommendations. For manually created stores, store owners can manually add their products in.
