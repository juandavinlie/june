  ...
  return (
    <Box display="flex" flexDirection="column" gap="10px" p="30px">
      ...
      <Typography variant="h6">
        ...
        from you and/or your customers once you have installed June: Information
        about you and others who may access June on behalf of your store, such
        as your name, address, email address, phone number, and billing
        information; Information about individuals who visit your store, such as
        their IP address, web browser details, time zone, and information about
        the cookies installed on the particular device.
      </Typography>
      <Typography variant="h6">
      ...
      <Typography variant="h6">
        ...
        in order to create a personalised AI chatbot that can answer questions
        from your customers. Additionally, we use this personal information to:
        Communicate with you; Optimize or improve the App; and Provide you with
      ...
      <Typography variant="h6">
        ...
        communications we believe may be of interest to you. If you are a
        European resident, you have the right to access personal information we
        hold about you and to ask that your personal information be corrected,
        ...
        are a European resident we note that we are processing your information
        in order to fulfill contracts we might have with you (for example if you
        ...
        and the United States. When you place an order through the Site, we will
        maintain your Order Information for our records until you ask us to
        delete this information. We may update this privacy policy from time to
        time in order to reflect, for example, changes to our practices or for
        other operational, legal or regulatory reasons. Contact Us For more
